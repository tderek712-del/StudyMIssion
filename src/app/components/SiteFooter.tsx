    ...
    >
      <div style={{ maxWidth: '1100px', margin: '0 auto', width: '100%', textAlign: 'center' }}>
        <nav style={{ display: 'flex', gap: 24, justifyContent: 'center', alignItems: 'center' }}>
          <a href="#" onClick={(e) => { e.preventDefault(); window.dispatchEvent(new Event('open-home')); }} style={{ color: '#c8c5be', textDecoration: 'none', fontFamily: "'EB Garamond', Georgia, serif'" }}>Home</a>
          <a href="#" onClick={(e) => { e.preventDefault(); window.dispatchEvent(new Event('open-articles')); }} style={{ color: '#c8c5be', textDecoration: 'none', fontFamily: "'EB Garamond', Georgia, serif'" }}>Articles</a>
