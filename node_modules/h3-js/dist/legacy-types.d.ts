declare module "h3-js" {
     ...
     * Use <code>h3IsValid</code> to check for a valid
     * hexagon (or pentagon) cell ID.
     * @static
     * @param  {H3IndexInput} h3Index  H3 index to check
     * @return {boolean}          Whether the index is valid
     */
    export function isValidIndex(h3Index: H3IndexInput): boolean;
    /**
     ...
     */
    export function getIndexDigit(h3Index: H3IndexInput, digit: number): number;
    /**
     ...
     * This is the inverse operation of `h3GetResolution`, `h3GetBaseCell`, and `getIndexDigit`.
     ...
     * @throws {H3Error}    If input is invalid
     */
    export function constructCell(baseCellNumber: number, digits: number[], res: number): H3Index;
    /**
     ...
     * @throws {H3Error}      If input is invalid
     */
    export function reverseDirectedEdge(edgeIndex: H3IndexInput): H3Index;
    /**
